...
public class OkHttpStreamFetcher implements DataFetcher<InputStream>, okhttp3.Callback {
    ...
    public OkHttpStreamFetcher(Context context, GlideUrl url) {
    ...
    public void loadData(
        ...
        final OkHttpClient client = TorUtils.getHttpClient(SharedPreferencesUtils.isAppUseTor(context));
        //client.cache().evictAll();
        Log.d(TAG, "OkHttp DataFetcher with TOR: " + (client.proxy() != null? "ON" : "OFF") + " preparing request...");
